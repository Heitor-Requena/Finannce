...
<body>
  ...
  <section id="section" style="width: 80%; margin: 100px auto;" class="d-flex justify-content-around flex-column">
    ...
    <div>
      <form action="ControleFeedBack-Cliente.php" method="get" id="frm_feedback" name="frm_feedback" class="form-control m-2 d-flex justify-content-around flex-column">
        <input type="text" name="Nome_Consultor" id="Nome_Consultor" class="form-control m-2" placeholder="Nome Consultor">

        <input type="email" name="Email_Consultor" id="Email_Consultor" class="form-control m-2" placeholder="Email Consultor">
        ...
        <input type="submit" class="iframe-btn btn m-3 btn-outline-light" name="btn_CadastrarFeedBack" id="btn_CadastrarFeedBack" value="Adicionar" onclick="CadastrarFeedBack(event)">
        <input type="submit"  class="iframe-btn btn m-3 btn-outline-light" name="btn_ExcluirFeedBack" id="btn_ExcluirFeedBack" value="Excluir" onclick="ExcluirFeedBack(event)">
        <input type="submit"  class="iframe-btn btn m-3 btn-outline-light" name="btn_ListarFeedBack" id="btn_ListarFeedBack" value="Listar" onclick="ListarFeedBack(event)">
      </form>
    </div>
  </section>
