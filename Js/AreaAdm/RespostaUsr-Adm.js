    ...
    $.ajax({
        ...
        .done(function (dadosPHP) {
            ...
            if (dadosPHP.trim() === "") {
                ...
                // CONSULTA EM Tabela
                var Tabela = '';
                Tabela += "<div class='table-responsive'><table class='table table-bordered table-striped table-dark table-striped ml-5 table-sm'";
    ...
    $.ajax({
        ...
        .done(function (dadosPHP) {
            ...
            if (dadosPHP.trim() === "") {
                ...
                // CONSULTA EM Tabela
                var Tabela = '';
                Tabela += "<div class='table-responsive'><table class='table table-bordered table-striped table-dark table-striped table-sm>'";
